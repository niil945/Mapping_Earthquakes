...
L.geoJson(sanFranAirport, {
    onEachFeature: function(feature, layer) {
        console.log(layer);
        layer.bindPopup("<h2> Airport code: " + feature.properties.faa + "</h2><h3>Airport name: " + feature.properties.name + "</h2>");
    }
}).addTo(map);
...
// id options: streets-v11, dark-v10, satellite-streets-v11
